...
class ConcertsControllerTest < ActionController::TestCase
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post :create, concert: { city: @concert.city, country: @concert.country, date: @concert.date, name: @concert.name, place: @concert.place, state: @concert.state }
    end
  ...
  test "should update concert" do
    patch :update, id: @concert, concert: { city: @concert.city, country: @concert.country, date: @concert.date, name: @concert.name, place: @concert.place, state: @concert.state }
    assert_redirected_to concert_path(assigns(:concert))
  end
